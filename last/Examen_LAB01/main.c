...
int main()
{
    ...
    int vaciarDatosP, lugarFree, publicaProducto, idProducto =  0, idP, modificaProducto, idAModificarP,idU, idAEliminarP, retorno, posicionProducto, cantidadVendida = 0, puntaje, acumuladorPuntajes = 0;
        ...
        switch(opcion)
        {
            ...
            case 7:
                ...
                if(retorno > 0)
                {
                    ...
                    scanf("%d", &puntaje);
                    //arrayUsuarios[idU].calificacion = puntaje;
